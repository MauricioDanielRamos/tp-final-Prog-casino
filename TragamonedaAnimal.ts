...
export class TragamonedaAnimal extends Juego implements ITragamoneda {
    ...
    private mostrarPremio(coincidencias: number, usuario: Usuario): void {
        ...
        switch (coincidencias){
            case 3: premio = this.apuesta * 15;
                    console.log(`¡Felicidades! Coincidieron los 3 emojis.`);
                    break;                    
            case 2: premio = this.apuesta * 6;
                    console.log(`¡Muy bien! Coincidieron 2 emojis.`);
                    break;            
            case 1: premio = this.apuesta * 2; // Duplica apuesta
        ...
        console.log(`Saldo final: ${this.convertirAPesosAR(usuario.getCreditos())} créditos.`);
    }
}
